        ...
        <div className="topbar-nav">
          <div onClick={() => setActive("home")}>
            ...
            <Link to={user.type === "user" ? "/talentdashboard" : "/seekerdashboard"}>
              <span className={active === "home" ? `nav_active topbar-icons-container` : "topbar-icons-container"}>
                {active === "home" ? (
          ...
          <div onClick={() => setActive("role")}>
            {user.type == "user" && (
              <Link to="/myrole">
                <span className={active === "role" ? `nav_active topbar-icons-container` : "topbar-icons-container"}>
                  {active === "role" ? (
          ...
          <div onClick={() => setActive("chair")}>
            {user.type == "seeker" && (
              <Link to="/submission">
                <span className={active === "chair" ? `nav_active topbar-icons-container` : "topbar-icons-container"}>
                  {active === "chair" ? (
          ...
          {user.type == "seeker" && (
            <Link to="/roles">
              <span className={active === "mask" ? `nav_active topbar-icons-container` : "topbar-icons-container"}
          ...
          {user.type == "seeker" && (
            <Link to="/browseprofile" onClick={() => setActive("fingers")}>
              <span className={active === "fingers" ? `nav_active topbar-icons-container` : "topbar-icons-container"}>
                {active === "fingers" ? (
          ...
          <span className={active === "chat" ? `nav_active topbar-icons-container` : "topbar-icons-container"}
